layui.use(['layer', 'table', 'ax', 'laydate'], function () {
    ...
    MchCashFlow.initColumn = function () {
        return [[
            ...
            {field: 'costAmount', align: 'center', width:100, title: '平台利润'},
    ...
    MchCashFlow.exportExcel = function () {
        DownLoadFile({
            url: Feng.ctxPath + '/business/report/mchCashReportExcelList?beginTime=' + $("#beginTime").val() + '&endTime=' + $("#endTime").val()
    ...
    var tableResult = table.render({
        ...
        url: Feng.ctxPath + '/business/report/mchCashReportList',
  ...
  //渲染时间选择框
    ...
    MchCashFlow.tongji = function(){
    	var ajax = new $ax(Feng.ctxPath + "/business/report/mchCashTj", function (data) {
