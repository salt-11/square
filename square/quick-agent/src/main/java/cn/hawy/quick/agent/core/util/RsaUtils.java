...
public class RsaUtils {
     ...
     * @throws Exception
     */
    public static String sign(String privateKeyFile,String password,String content) throws Exception{
    	String privateKey = KeyUtil.getPrimaryKey(privateKeyFile,password);
