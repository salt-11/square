...
import cn.hawy.quick.agent.core.util.CollectionKit;
...
import cn.hawy.quick.agent.modular.business.service.TPayOrderService;
...
import cn.hawy.quick.agent.modular.business.warpper.OrderWrapper;
...
public class OrderController extends BaseController {
    ...
    public Object payOrderlist(@RequestParam(required = false) String beginTime,
        ...
        List<Map<String, Object>> result = payOrderService.findAll(page, shiroUser.getId(),deptId, beginTime, endTime, orderId, outTradeNo,mchId,orderStatus,channelNo);
    ...
    public Object payOrderHistoryList(@RequestParam(required = false) String beginTime,
        ...
        Page page = LayuiPageFactory.defaultPage();
        ShiroUser shiroUser = ShiroKit.getUserNotNull();
        List<Map<String, Object>> result = payOrderService.findHistoryAll(page, shiroUser.getId(),deptId, beginTime, endTime, orderId, outTradeNo,mchId,orderStatus,channelNo);
        page.setRecords(new OrderWrapper(result).wrap());
        return LayuiPageFactory.createPageInfo(page);
    }
                                  ...
                                  HttpServletRequest request, HttpServletResponse response) throws Exception
    {
        try {
            ...
            List<PayOrderContact> dataVals = new ArrayList<PayOrderContact>();
            ShiroUser shiroUser = ShiroKit.getUserNotNull();
            List<TPayOrder> pay = payOrderService.find(shiroUser.getId(), deptId, beginTime, endTime,orderId, outTradeNo, mchId, orderStatus, channelNo);
