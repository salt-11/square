 ...
 */
package cn.hawy.quick.agent.core.shiro.service.impl;
...
import cn.hawy.quick.agent.core.shiro.service.UserAuthService;
import cn.hawy.quick.agent.modular.system.entity.User;
import cn.hawy.quick.agent.modular.system.mapper.MenuMapper;
import cn.hawy.quick.agent.modular.system.mapper.UserMapper;
...
public class UserAuthServiceServiceImpl implements UserAuthService {
    ...
    public User user(String account) {
        ...
        List<String> deptIdList = userService.getDeptIdsByUserId(user.getId());
