...
public class GyfMchValidate {
	...
	public static void main(String[] args) {
		...
		System.out.println(RandomUtil.randomEle(gender));
	}
	...
	public static void register(RegisterDto registerDto) {
		...
		if(StrUtil.isEmpty(registerDto.getSettleCardNo())) {
			throw new RestException(401, "settleCardNo不能为空!");
		}
...
//		if(StrUtil.isEmpty(bindCardDto.getCityCode()) && StrUtil.isEmpty(bindCardDto.getTerminalIp())) {
//			throw new RestException(401, "cityCode和terminalIp不能同时为空!");
//		}
	...
	public static void withdraw(WithdrawDto withdrawDto) {
		...
		if(StrUtil.isEmpty(withdrawDto.getMobile())) {
			throw new RestException(401, "mobile不能为空!");
		}
