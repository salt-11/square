...
import cn.hawy.quick.modular.system.entity.Dict;
...
public interface IConstantFactory {
     ...
     * 获取商户类型名称
     */
    String getMchTypeName(String mchTypeCode);
    
    /**
     * 获取商户业务类型名称
     */
    String getMchBizTypeName(String bizTypeCode);
     ...
     * 获取商户变动方向名称
     */
    String getMchDirectionName(String direction);
