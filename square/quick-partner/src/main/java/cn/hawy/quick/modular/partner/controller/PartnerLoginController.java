 ...
 */
package cn.hawy.quick.modular.partner.controller;

import cn.hawy.quick.core.common.node.MenuNode;
...
public class PartnerLoginController extends BaseController {
    ...
    private static String PREFIX = "/modular/partner";
    ...
    public String index(Model model) {
        ...
        if(user.getAccount().equals("t2000601")){
