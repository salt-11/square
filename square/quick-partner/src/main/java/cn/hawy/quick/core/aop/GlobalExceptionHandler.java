...
public class GlobalExceptionHandler {
    ...
    public ErrorResponseData notFount(RuntimeException e) {
        ...
        getRequest().setAttribute("tip", "服务器未知运行时异常");
        log.error("运行时异常:", e);
        //return new RestResponse(BizExceptionEnum.SERVER_ERROR.getCode(), BizExceptionEnum.SERVER_ERROR.getMessage());
        return new ErrorResponseData(BizExceptionEnum.SERVER_ERROR.getCode(), BizExceptionEnum.SERVER_ERROR.getMessage());
    }
    ...
    @ResponseStatus(HttpStatus.OK)
    @ResponseBody
    public RestResponse restException(RestException e) {
        log.error("业务异常:", e);
