package cn.hawy.quick.modular.api.validate.paf;


import java.util.Date;

import cn.hawy.quick.core.common.exception.RestException;
import cn.hawy.quick.modular.api.dto.paf.BalanceQueryDto;
import cn.hawy.quick.modular.api.dto.paf.BindCardDto;
import cn.hawy.quick.modular.api.dto.paf.RegisterDto;
import cn.hawy.quick.modular.api.dto.paf.WithdrawDto;
import cn.hawy.quick.modular.api.dto.paf.WithdrawQueryDto;
import cn.hutool.core.date.DateUnit;
import cn.hutool.core.date.DateUtil;
import cn.hutool.core.util.NumberUtil;
import cn.hutool.core.util.StrUtil;

public class PafMchValidate {
	...
	public static void binkCard(BindCardDto bindCardDto) {
		...
		if(StrUtil.isEmpty(bindCardDto.getFrontUrl())) {
			throw new RestException(401, "frontUrl不能为空!");
		}
		if(StrUtil.isEmpty(bindCardDto.getNotifyUrl())) {
