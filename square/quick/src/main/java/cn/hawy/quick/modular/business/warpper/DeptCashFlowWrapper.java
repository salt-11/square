 ...
 */
public class DeptCashFlowWrapper extends BaseControllerWrapper {

    public DeptCashFlowWrapper(Map<String, Object> single) {
        super(single);
    }

    public DeptCashFlowWrapper(List<Map<String, Object>> multi) {
        super(multi);
    }
