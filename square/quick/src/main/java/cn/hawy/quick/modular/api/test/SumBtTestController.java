...
public class SumBtTestController {
	...
	public static String url = "http://localhost:8010/api/vs/bt/";
...
//		System.out.println(StrUtil.subPre(cardNo,6)+"*****"+StrUtil.subSuf(cardNo,-4));
	...
	public static void orderNotify() {
		...
		paramMap.put("order_no","1418468653865033729");
		paramMap.put("status","1");


		String result= HttpUtil.post(url+"pay/orderNotify", JSONUtil.toJsonStr(paramMap));
	...
	public static void orderAppley() {
    	...
    	paramMap.put("outTradeNo", "20210723003");
    	paramMap.put("goodsName", "test0001");
    	paramMap.put("orderAmount", "50000");
    	...
    	paramMap.put("agentCardNo", "1111111111111111");
